...
type Meta struct {
	...
	Entries map[string]*any.Any `protobuf:"bytes,1,rep,name=entries,proto3" json:"entries,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *Meta) GetEntries() map[string]*any.Any {
	if x != nil {
		return x.Entries
	}
	return nil
